...
public class Clean {
	public static void main(String[] args) throws Exception {
		if (args.length != 3) {
			System.err.println("Usage: Clean <input path> <output path> <data_type>");
			System.exit(-1);
		}
		...
		if (dataType.equals("soc")) {
			conf.set("delimiter", "\t");
			conf.set("columns", "2 GeoName string 3 GeoID string 4 Borough string 5 TotalHouseholds int 75 AvgHouseholdSize float 225 Pop25AndOver int 230 LessThan9 int 235 9to12NoDip int 20 MarriedCoupleFam int 30 SingleMaleParentFam int 40 SingleFemaleParentFam int"); // soc
			...
			System.err.println("Usage: Clean <input path> <output path> <data_type>. data_type must be one of (soc | demo | econ | area)");
			System.exit(-1);
		}
